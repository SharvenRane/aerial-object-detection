"""
Aerial Object Detection - Model Architecture
"""
import torch
...
class AerialObjectDetection(nn.Module):
    """
    Main model for aerial object detection.
    """
...
def build_model(config):
    model = AerialObjectDetection(config)
